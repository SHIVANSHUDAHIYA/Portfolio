...
const testimonials: TTestimonial[] = [
  ...
  },
  {
    ...
    company: "NSUT ",
    image: "https://res.cloudinary.com/dtavbfyze/image/upload/v1741969782/kshitizz_tnkynh.jpg",
  },
  {
...
const projects: TProject[] = [
  ...
  },
  {
    name: "Ebike",
    description:
      "A sleek, futuristic design with smooth gradients, minimalistic elements, and an intuitive layout, enhancing product presentation and user interaction. ",
    tags: [
      {
        name: "Figma",
        color: "blue-text-gradient",
  ...
  },
  {
    name: "Quiz",
    description:
      "Developed an AI-powered quiz platform with FastAPI, SQLAlchemy. Used OpenAI API for quiz generation and WebSockets for real-time multiplayer. Built a responsive UI with Next.js and Tailwind CSS.",
    tags: [
      {
        name: "Next.js",
        color: "blue-text-gradient",
